...
?>
            <div class="container">
                <form action="<?=$base?>/admin/product/update/<?=$product->id?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="name">Nome</label>
                        <input type="text" name="name" id="name" class="input-control" value="<?=$product->name?>">
                    </div>
                    <div class="form-group">
                        <label for="description">Descrição</label>
                        <textarea name="description" id="description" class="input-control"><?=$product->description?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="price">Preço</label>
                        <input type="number" step="0.01" min="0" name="price" id="price" class="input-control" value="<?=$product->price?>">
                    </div>
                    <div class="form-group">

                ...
                <div class="product">
                    <a href="#">
                        ...
                        <div class="product-action">
                            ...
                            <form action="<?=$base?>/wish/remove" method="post">
                                <input type="hidden" name="product" value="<?=$product->id?>">
                                <button type="submit" title="Remover dos favoritos" class="btn-small love"><i class="far fa-heart"></i></button>
                            </form>
                        ...
                        <p class="description">
                            <?php
$pos = strpos($product->description, ' ', min(strlen($product->description), 50));
